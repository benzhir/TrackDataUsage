...
import static com.hc2i.datamonitor.core.Values.DATA_USAGE_NOTIFICATION_ID;
import static com.hc2i.datamonitor.core.Values.DATA_USAGE_NOTIFICATION_NOTIFICATION_GROUP;
import static com.hc2i.datamonitor.core.Values.NOTIFICATION_MOBILE_DATA;
...
//                builder.setContentTitle(context.getString(R.string.title_data_usage_notification));
    ...
    public static class NotificationRemover extends BroadcastReceiver {
        private static final String TAG = com.hc2i.datamonitor.utils.NotificationService.class.getSimpleName();
