...
package com.hc2i.datamonitor.ui.activities;

import static com.hc2i.datamonitor.Common.isAppInstalled;
import static com.hc2i.datamonitor.Common.isReadPhoneStateGranted;
import static com.hc2i.datamonitor.Common.isUsageAccessGranted;
import static com.hc2i.datamonitor.Common.refreshService;
import static com.hc2i.datamonitor.Common.setLanguage;
import static com.hc2i.datamonitor.core.Values.ALARM_PERMISSION_DENIED;
import static com.hc2i.datamonitor.core.Values.APP_COUNTRY_CODE;
import static com.hc2i.datamonitor.core.Values.APP_DATA_USAGE_WARNING_CHANNEL_ID;
import static com.hc2i.datamonitor.core.Values.APP_DATA_USAGE_WARNING_CHANNEL_NAME;
import static com.hc2i.datamonitor.core.Values.APP_LANGUAGE_CODE;
import static com.hc2i.datamonitor.core.Values.APP_THEME;
import static com.hc2i.datamonitor.core.Values.BOTTOM_NAVBAR_ITEM_SETTINGS;
import static com.hc2i.datamonitor.core.Values.DATA_RESET_DATE;
import static com.hc2i.datamonitor.core.Values.DATA_USAGE_NOTIFICATION_CHANNEL_ID;
import static com.hc2i.datamonitor.core.Values.DATA_USAGE_NOTIFICATION_CHANNEL_NAME;
import static com.hc2i.datamonitor.core.Values.DATA_USAGE_SYSTEM;
import static com.hc2i.datamonitor.core.Values.DATA_USAGE_VALUE;
import static com.hc2i.datamonitor.core.Values.DATA_USAGE_WARNING_CHANNEL_ID;
import static com.hc2i.datamonitor.core.Values.DATA_USAGE_WARNING_CHANNEL_NAME;
import static com.hc2i.datamonitor.core.Values.DISABLE_BATTERY_OPTIMISATION_FRAGMENT;
import static com.hc2i.datamonitor.core.Values.GENERAL_FRAGMENT_ID;
import static com.hc2i.datamonitor.core.Values.NETWORK_SIGNAL_CHANNEL_ID;
import static com.hc2i.datamonitor.core.Values.NETWORK_SIGNAL_CHANNEL_NAME;
import static com.hc2i.datamonitor.core.Values.OTHER_NOTIFICATION_CHANNEL_ID;
import static com.hc2i.datamonitor.core.Values.OTHER_NOTIFICATION_CHANNEL_NAME;
import static com.hc2i.datamonitor.core.Values.READ_PHONE_STATE_DISABLED;
import static com.hc2i.datamonitor.core.Values.REQUEST_POST_NOTIFICATIONS;
import static com.hc2i.datamonitor.core.Values.SESSION_TODAY;
import static com.hc2i.datamonitor.core.Values.SETUP_COMPLETED;
import static com.hc2i.datamonitor.core.Values.SETUP_VALUE;
import static com.hc2i.datamonitor.core.Values.SHOULD_SHOW_BATTERY_OPTIMISATION_ERROR;
import static com.hc2i.datamonitor.core.Values.TYPE_MOBILE_DATA;
import static com.hc2i.datamonitor.core.Values.UPDATE_NOTIFICATION_CHANNEL;
import static com.hc2i.datamonitor.core.Values.UPDATE_VERSION;
import static com.hc2i.datamonitor.core.Values.USAGE_ACCESS_DISABLED;
import static com.hc2i.datamonitor.ui.fragments.AppDataUsageFragment.getAppContext;
import static com.hc2i.datamonitor.ui.fragments.AppDataUsageFragment.onDataLoaded;
import static com.hc2i.datamonitor.utils.NetworkStatsHelper.getAppMobileDataUsage;
import static com.hc2i.datamonitor.utils.NetworkStatsHelper.getAppWifiDataUsage;
import static com.hc2i.datamonitor.utils.NetworkStatsHelper.getDeletedAppsMobileDataUsage;
import static com.hc2i.datamonitor.utils.NetworkStatsHelper.getDeletedAppsWifiDataUsage;
import static com.hc2i.datamonitor.utils.NetworkStatsHelper.getDeviceMobileDataUsage;
import static com.hc2i.datamonitor.utils.NetworkStatsHelper.getDeviceWifiDataUsage;
import static com.hc2i.datamonitor.utils.NetworkStatsHelper.getTetheringDataUsage;
...
import com.hc2i.datamonitor.BuildConfig;
import com.hc2i.datamonitor.R;
import com.hc2i.datamonitor.Widget.DataUsageWidget;
import com.hc2i.datamonitor.adapters.data.AppDataUsageModel;
import com.hc2i.datamonitor.core.task.DatabaseHandler;
import com.hc2i.datamonitor.databinding.ActivityMainBinding;
import com.hc2i.datamonitor.utils.CrashReporter;
import com.hc2i.datamonitor.utils.SharedPreferences;
