...
import static com.hc2i.datamonitor.core.Values.DAILY_DATA_HOME_ACTION;
...
import static com.hc2i.datamonitor.core.Values.DATA_RESET_CUSTOM_DATE_END;
...
import static com.hc2i.datamonitor.core.Values.DATA_USAGE_SESSION;
import static com.hc2i.datamonitor.core.Values.DATA_USAGE_TODAY;
import static com.hc2i.datamonitor.core.Values.DATA_USAGE_TYPE;
import static com.hc2i.datamonitor.core.Values.GENERAL_FRAGMENT_ID;
import static com.hc2i.datamonitor.core.Values.SESSION_CUSTOM;
import static com.hc2i.datamonitor.core.Values.SESSION_MONTHLY;
import static com.hc2i.datamonitor.core.Values.SESSION_TODAY;
import static com.hc2i.datamonitor.core.Values.SHOW_ADD_PLAN_BANNER;
import static com.hc2i.datamonitor.core.Values.TYPE_MOBILE_DATA;
import static com.hc2i.datamonitor.core.Values.TYPE_WIFI;
import static com.hc2i.datamonitor.ui.activities.MainActivity.setRefreshAppDataUsage;
...
import static com.hc2i.datamonitor.utils.NetworkStatsHelper.updateOverview;
...
import com.hc2i.datamonitor.adapters.data.OverviewModel;
...
//        intent.putExtra(GENERAL_FRAGMENT_ID, DATA_USAGE_WEEKDAY);
//        intent.putExtra(EXTRA_WEEK_DAY, getWeekDay(v));
//        intent.putExtra(EXTRA_IS_WEEK_DAY_VIEW, true);
//        startActivity(intent);
//    }

//    private String getWeekDay(View vIew) {
//        String day = "";
//        if (vIew.getId() == R.id.view_mon) {
//            day = requireContext().getString(R.string.label_mon);
//        }
//        else if (vIew.getId() == R.id.view_tue) {
//            day = requireContext().getString(R.string.label_tue);
//        }
//        else if (vIew.getId() == R.id.view_wed) {
//            day = requireContext().getString(R.string.label_wed);
//        }
//        else if (vIew.getId() == R.id.view_thurs) {
//            day = requireContext().getString(R.string.label_thurs);
//        }
//        else if (vIew.getId() == R.id.view_fri) {
//            day = requireContext().getString(R.string.label_fri);
//        }
//        else if (vIew.getId() == R.id.view_sat) {
//            day = requireContext().getString(R.string.label_sat);
//        }
//        else if (vIew.getId() == R.id.view_sun) {
//            day = requireContext().getString(R.string.label_sun);
//        }
//
//        return day;
//    }
